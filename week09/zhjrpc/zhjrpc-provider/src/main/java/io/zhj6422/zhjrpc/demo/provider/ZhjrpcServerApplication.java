...
import io.zhj6422.zhjrpc.api.ServiceProviderDesc;
...
import io.zhj6422.zhjrpc.server.ZhjrpcInvoker;
...
@RestController
public class ZhjrpcServerApplication {
...
//		registerService(client, orderService);
    ...
    SpringApplication.run(ZhjrpcServerApplication.class, args);
  }
  ...
  @Autowired
  ZhjrpcInvoker invoker;

  @PostMapping("/")
  public ZhjrpcResponse invoke(@RequestBody ZhjrpcRequest request) {
    return invoker.invoke(request);
  }

  @Bean
  public ZhjrpcInvoker createInvoker(@Autowired ZhjrpcResolver resolver){
    return new ZhjrpcInvoker(resolver);
  }

  @Bean
  public ZhjrpcResolver createResolver(){
  ...
  @Bean(name = "io.zhj6422.zhjrpc.demo.api.UserService")
  public UserService createUserService(){
    return new UserServiceImpl();
  }

  @Bean(name = "io.zhj6422.zhjrpc.demo.api.OrderService")
