...
//		ClusterJedis.close();
		...
		// Cluster操作
//		JedisCluster jedisCluster = ClusterJedis.getJedisCluster();
//		jedisCluster.set("uptime3", new Long(System.currentTimeMillis()).toString());
//		System.out.println(jedisCluster.get("uptime3"));
//		ClusterJedis.close();
